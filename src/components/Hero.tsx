  ...
  return (
    <motion.div style={{ x, y }} className="relative w-48 h-48 mx-auto mb-8">
      ...
      <motion.div
        ...
        className="relative w-48 h-48 rounded-full bg-linear-to-br from-indigo-500 via-violet-600 to-purple-700 flex items-center justify-center shadow-2xl shadow-indigo-500/40"
      >
...
function AnimatedName() {
  ...
  return (
    <h1 className="text-5xl md:text-7xl font-black text-white tracking-tight mb-4 flex flex-wrap justify-center">
      {chars.map((char, i) =>
        char === " " ? (
  ...
  return (
    <section id="hero" className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 pt-20 overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 bg-purple-600/5 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        <motion.p {...fadeUp(0.7)} className="text-lg md:text-xl text-indigo-300 font-semibold mb-3">
          Full-Stack Software Engineer
        </motion.p>

        <motion.p {...fadeUp(0.9)} className="text-slate-400 text-base md:text-lg max-w-xl mx-auto mb-2">
          {personal.summary}
        </motion.p>

        <motion.p {...fadeUp(1.0)} className="text-slate-500 text-sm mb-8">
